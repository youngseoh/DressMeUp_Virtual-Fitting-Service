# -*- coding: utf-8 -*-
"""dressup_longpants, longskirt.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IoSm01lS7Qgm8VlccWGB_2gAJVshYTTa
"""
...
def longpants_skirt(image_path, cloth_path):
    ...
    def poseDetector(frame):
        ...
        return LHip, RHip, RAnkle, LAnkle, frame

    # poseDetector 함수를 사용하여 이미지 처리
    LHip, RHip, RAnkle, LAnkle, image = poseDetector(image)
    ...
    # y 값 차이 계산
    y_left = (LHip[1]-LAnkle[1]) * 0.03
    y_right= (RHip[1]-RAnkle[1]) * 0.03
    ...
    pts_dst = np.float32([LHip1, RHip1, RAnkle1, LAnkle1])
